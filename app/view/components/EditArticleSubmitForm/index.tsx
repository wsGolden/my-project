...
const EditArticleSubmitForm = React.forwardRef(
  ({ onSubmit, onCancel, recordId, content }: Iprops, ref) => {
    ...
    const handleSubmit = async (values: any) => {
      const formValues = {
        ...values,
        articlePicId: values.articlePicId
          ? getImageIds(values.articlePicId)
          : "",
      };
      if (recordId) {
