...
/** 从错误code表中查找指定的code码 */
const findErrorCode = (code: string) =>
  codeList.find((codeItem) => codeItem.code === code);
...
const axiosInstance = axios.create({
  baseURL:
    process.env.NODE_ENV === "development"
      ? process.env.serverServiceBaseUrl
      : process.env.serviceBaseUrl,
